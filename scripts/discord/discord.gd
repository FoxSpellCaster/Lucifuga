...
func _ready():
	...
	send_discord_message("Player has connected")

func send_discord_message(message: String):
	# Prepare the JSON payload for Discord
	var payload = {
		"content": message,
		"username": "Lucifuga Bot",  # Optional: Customize the bot's name
		"avatar_url": "https://godotengine.org/assets/error_logo.svg"  # Optional: Customize the avatar
	}
	...
	print ("Discord Webhook Message Sent", send_discord_message)
